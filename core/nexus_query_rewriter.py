...
_NEXUS_NL_TO_INCIDENT_NODES = {
    ...
    # 인사사고 / 안전 응급 도메인 — 종결형 직접 매핑 ('응급조치' 노드 emit
    # 으로 AEO 출입통제 차별화). 기존 "다쳤" 키는 본 블록에서 override.
    "넘어졌어": [("인사사고", "고객상해"), ("인사사고", "시설안전"), ("인사사고", "응급조치")],
    "넘어졌":   [("인사사고", "고객상해"), ("인사사고", "시설안전"), ("인사사고", "응급조치")],
    "넘어짐":   [("인사사고", "고객상해"), ("인사사고", "시설안전"), ("인사사고", "응급조치")],
    "넘어진":   [("인사사고", "고객상해"), ("인사사고", "시설안전"), ("인사사고", "응급조치")],
    "다쳤어요": [("인사사고", "고객상해"), ("인사사고", "응급조치")],
    "다쳤어":   [("인사사고", "고객상해"), ("인사사고", "응급조치")],
    "다쳤음":   [("인사사고", "고객상해"), ("인사사고", "응급조치")],
    "다쳤":     [("인사사고", "고객상해"), ("인사사고", "응급조치")],
    "미끄러져": [("인사사고", "고객상해"), ("인사사고", "시설안전"), ("인사사고", "응급조치")],
    "미끄러짐": [("인사사고", "고객상해"), ("인사사고", "시설안전"), ("인사사고", "응급조치")],
