...
2. standard: 일반적인 사규나 절차의 단순 조회 목적 (긴급 조치 불필요)
   예: "징계 기준", "휴가 일수", "교육 신청 절차"
3. complex: 4개 이상 사규 인용이 필요한 복합 query
   예: "외부 강의 강의료 처리 + 클린뱅크 이관 + 신고 절차"
4. critical: 비위/사고/위반 사항의 '발견'·'인지'·'제보'·'신고' 관련 query.
   즉시 보고, 24시간 內 SRMS 등록, 핫라인 접수 등 긴급 조치가 필요한 사안.
   예: "폭행", "중대재해", "횡령", "성희롱", "정보유출", "범죄사실", "위반사실"
