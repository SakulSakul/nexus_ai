...
AMBIGUOUS_BARE_TOKENS: dict[str, dict] = {
    "발주": {
        ...
        "choices": [
            {"label": "상품 발주 (입고·반출입)", "query": "상품 발주 등록 절차"},
            {"label": "구매 발주 품의·결재", "query": "구매 발주 품의 결재 절차"},
            {"label": "협력사 발주 (입점·거래)", "query": "협력사 발주 처리 절차"},
        ],
    },
    "감사": {
        "prompt": "'감사'는 종류에 따라 적용 사규가 다릅니다. 어느 감사를 찾으시나요?",
        "choices": [
            {"label": "내부회계 감사", "query": "내부회계관리제도 감사 절차"},
            {"label": "정보보호·보안 감사", "query": "정보보호 보안 감사 절차"},
            {"label": "AEO 감사", "query": "AEO 내부심사 절차"},
            {"label": "감사위원회", "query": "감사위원회 운영 절차"},
        ],
    },
}
