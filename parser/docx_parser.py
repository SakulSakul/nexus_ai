...
_CATEGORY_KEYWORDS = {
    ...
    "총무":     ("자산관리", "차량", "출장", "총무", "행정"),
    # 인사 카테고리는 조직문화·예방지침 영역 한정 (행정 인사는 별도 인사봇 처리).
    # 적재 대상 docx: 업무인수인계지침 / 사내 동호회 운영지침 /
    # 건전한 조직문화 조성 자율준수 지침 / 성희롱 예방지침 /
    # 직장내 괴롭힘 예방대응 지침.
    "인사":     ("업무인수인계", "인수인계", "동호회", "조직문화",
                 "자율준수", "성희롱 예방", "괴롭힘 예방", "예방지침", "예방 지침"),
